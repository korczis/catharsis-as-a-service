...
[extra]
figures = [
  { kind = "posters", id = "poster-about", caption = "From the Catharsis as a Service poster series. Slogans and numbers on the posters belong to the artwork; they are not findings.", items = [{ src = "assets/posters/informace-meni-moc.png", title = "Information changes power", alt = "Poster: INFORMACE MĚNÍ MOC (information changes power) beside a cracked classical stone head; a figure walks down a corridor of archive screens labelled people, companies, relationships, timelines, documents, patterns, anomalies, questions and answers towards a red doorway.", caption = "A more informed society is a harder society to manipulate." }] },
