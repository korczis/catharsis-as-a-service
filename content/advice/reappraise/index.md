+++
title = "Change the interpretation before trying to release the emotion"
description = "Cognitive reappraisal, reconsidering what a situation means, changes emotional experience more reliably than suppressing it or dwelling on it. How to practise it and when it is not the right tool."
date = 2026-09-14
weight = 1

[taxonomies]
tags = ["emotion regulation", "reappraisal", "anger"]

[extra]
kicker = "Advice 01"
evidence_grade = "meta-analytic"
evidence_label = "Meta-analytic"
recommendation = "When an emotion is building, first examine and, where justified, revise how you are interpreting the situation. Reappraisal changes how an emotion is experienced; suppression and rumination generally do not."
practice = [
  "Name the situation in one neutral sentence, describing only what happened, without adjectives or motives.",
  "Write down the interpretation that is producing the emotion, for example \"they ignored me on purpose\".",
  "List at least two other interpretations that fit the same facts, and note what evidence would distinguish them.",
  "Ask what you would say to a friend in the same situation, then apply that answer to yourself.",
  "Decide on one action that makes sense under the most plausible interpretation, and set the rest aside for now.",
]
limits = [
...
Gross's process model of emotion regulation distinguishes strategies by the point at which they act on an emotion as it unfolds (Gross, 1998). Reappraisal acts early: it changes the meaning of the situation, and with it the emotional response the situation produces. Suppression acts late: it inhibits the outward expression of an emotion that has already been generated.

The difference has measurable consequences. Neuroimaging studies show that reappraisal recruits prefrontal and cingulate control systems that modulate activity in emotion-generating regions such as the amygdala (Ochsner & Gross, 2005). In everyday life, people who habitually reappraise report experiencing more positive and less negative emotion and have better interpersonal functioning and well-being than people who habitually suppress (Gross & John, 2003).
