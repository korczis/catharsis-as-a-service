<!-- generated by `majordomus update` from .ai/repo/policy.yaml (policy 021bc2a0f24b, content 27cfd5794d5babab) — do not edit; edit the policy and regenerate -->
# GEMINI.md

Gemini bootstrap. The repository's provider-neutral AI context lives under
[`.ai/`](.ai/); nothing specific to Gemini is needed here.
