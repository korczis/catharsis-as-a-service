...
check "/theory/" "${BASE}theory/"
check "/cs/theory/" "${BASE}cs/theory/"
check "/models/" "${BASE}models/"
check "/cs/modely/" "${BASE}cs/modely/"
check "/search/" "${BASE}search/"
check "/cs/hledat/" "${BASE}cs/hledat/"
check "/case-study/" "${BASE}case-study/"
check "/cs/pripadova-studie/" "${BASE}cs/pripadova-studie/"
check "/engineering/" "${BASE}engineering/"
check "/engineering/time-…/" "${BASE}engineering/time-accounting/"
check "/artifacts/closure-…/" "${BASE}artifacts/closure-as-a-service/"
check "poster closure" "${BASE}assets/closure-as-a-service.png"
check "search index en" "${BASE}api/v1/search.en.json"
check "search index cs" "${BASE}api/v1/search.cs.json"
check "og preview home" "${BASE}og/_index.jpg"
