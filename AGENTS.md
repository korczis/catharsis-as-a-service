<!-- generated by `majordomus update` from .ai/repo/policy.yaml (policy 021bc2a0f24b, content c95d3868f071d0b8) — do not edit; edit the policy and regenerate -->
# AGENTS.md
...
case that executes, per `.ai/repo/workflows/use-cases.md`; `finish` refuses a required
gap.
